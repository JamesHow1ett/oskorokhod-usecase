...
- Fixed `npm auth` in publish workflow

## [1.0.1] - 2026-06-22

### Added

- Added GitHub Actions workflow to publish on tag

### Changed

- Changed `publishConfig.tag` to `'latest'`

### Fixed

- Downgrade the minimal NodeJS version to `18+`
